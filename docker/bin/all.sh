...
TIME_MSG_LABEL= TIME_MSG_PREFIX= TAG_PREFIX=3.12-perf DOCKER_BUILD_ENABLE_OPTIMIZATIONS=true $BUILD_CONTEXT/$bin_dir/build.sh $REPO_NAME $REMOTE_USER --build-arg PYTHON_VERSION=3.12 $* $BUILD_CONTEXT
TIME_MSG_LABEL= TIME_MSG_PREFIX= TAG_PREFIX=3.12-perf $BUILD_CONTEXT/$bin_dir/publish.sh $REPO_NAME $REPO_NAMESPACE
TIME_MSG_LABEL= TIME_MSG_PREFIX= TAG_PREFIX=3.12-dev DOCKER_BUILD_PYTHON_DEV=true DOCKER_BUILD_ENABLE_BOLT=false $BUILD_CONTEXT/$bin_dir/build.sh $REPO_NAME $REMOTE_USER --build-arg PYTHON_VERSION=3.12 $* $BUILD_CONTEXT
TIME_MSG_LABEL= TIME_MSG_PREFIX= TAG_PREFIX=3.12-dev $BUILD_CONTEXT/$bin_dir/publish.sh $REPO_NAME $REPO_NAMESPACE
...
TIME_MSG_LABEL= TIME_MSG_PREFIX= TAG_PREFIX=3.14-perf DOCKER_BUILD_ENABLE_OPTIMIZATIONS=true $BUILD_CONTEXT/$bin_dir/build.sh $REPO_NAME $REMOTE_USER --build-arg PYTHON_VERSION=3.14 $* $BUILD_CONTEXT
TIME_MSG_LABEL= TIME_MSG_PREFIX= TAG_PREFIX=3.14-perf $BUILD_CONTEXT/$bin_dir/publish.sh $REPO_NAME $REPO_NAMESPACE
TIME_MSG_LABEL= TIME_MSG_PREFIX= TAG_PREFIX=3.14-dev DOCKER_BUILD_PYTHON_DEV=true DOCKER_BUILD_ENABLE_BOLT=false $BUILD_CONTEXT/$bin_dir/build.sh $REPO_NAME $REMOTE_USER --build-arg PYTHON_VERSION=3.14 $* $BUILD_CONTEXT
TIME_MSG_LABEL= TIME_MSG_PREFIX= TAG_PREFIX=3.14-dev $BUILD_CONTEXT/$bin_dir/publish.sh $REPO_NAME $REPO_NAMESPACE
